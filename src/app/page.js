      ...
      <div className="flex flex-col gap-20">
        <div className="relative">
          ...
          <motion.div
            ...
            className="p-8 md:py-10 md:px-20 bg-[#EBEAF7] hover:shadow-lg transition-shadow rounded-xl shadow-lg absolute md:top-137 top-180"
          >
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-xl md:text-3xl font-bold text-ring mb-4">
                Our Core Services
              </h2>
              <p className="text-ring text-base max-w-2xl mx-auto">
        ...
        <section className="relative lg:mt-100 mt-150 mb-105 md:mb-60">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 items-center">
              <div className="flex flex-col align-items-start justify-utems-start">
                ...
                <p className="text-purple-100 text-md mb-6 leading-relaxed">
                  At Digiline, we are redefining the telecommunications
                  landscape with innovative, reliable, and customer-focused
                  solutions. With years of experience in the industry, we have
                  built a strong track record in delivering SMS, USSD, voice,
                  API development, airtime, and data services that help
                  businesses communicate effectively, streamline operations, and
                  unlock new growth opportunities. Our solutions are tailored to
                  client needs and backed by official accreditation from the NCC
                  and other recognized VAS authorities, ensuring quality,
                ...
                <p className="text-purple-100 text-md mb-8 leading-relaxed">
                  ...
                  technology they gain a strategic, accredited partner for
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: false, amount: 0.3 }}
            className="bg-[#EBEAF7] py-10 px-5 md:py-15 md:px-20 rounded-t-[80px] border border-purple-100 hover:shadow-lg transition-shadow absolute top-[70rem] md:top-[60rem] lg:top-[48rem]"
          >
